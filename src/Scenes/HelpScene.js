...
export default class HelpScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.textInstructions = this.add.text(210, 260,
    ...
    this.intro = this.add.text(215, 400, 'Enter your name: ', { fontSize: 20 });
    ...
    const gameButton = this.add.dom(615, 410, 'button', style, 'Play');
