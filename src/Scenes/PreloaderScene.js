...
export default class PreloaderScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('phaserLogo', 'assets/image/logo.png');
    ...
    this.load.spritesheet('cowboy', 'assets/image/cowboy.png', { frameWidth: 45, frameHeight: 44 });
    this.load.spritesheet('bullets', 'assets/image/bullets.png', { frameWidth: 32, frameHeight: 32 });
    this.load.image('up', 'assets/image/up.png');
    this.load.image('left', 'assets/image/left.png');
    this.load.image('right', 'assets/image/right.png');
  }
